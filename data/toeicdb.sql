...
-- Thời gian đã tạo: Th5 21, 2025 lúc 02:04 PM
...
(463, 4, 'Why is the woman calling?', NULL, 'C', 'To make an appointment', 'To rent a car', 'To ask about a fee', 'To apply for a position', NULL, 2),
(464, 4, 'According to the man, what has recently changed?', NULL, 'C', 'Office hours', 'Job requirements', 'A computer system', 'A company policy', NULL, 2),
(465, 4, 'What does the man agree to do?', NULL, 'A', 'Waive a fee', 'Reschedule a meeting', 'Sign a contract', 'Repair a vehicle', NULL, 2),
(466, 4, 'What is the topic of the conversation?', NULL, 'B', 'Health', 'Traffic', 'Sports', 'Finance', NULL, 2),
(467, 4, 'What caused a problem?', NULL, 'D', 'A staffing change', 'A rainstorm', 'A typographical error', 'A road closure', NULL, 2),
(468, 4, 'What will the listeners hear next?', NULL, 'C', 'A commercial', 'A song', 'A weather report', 'A reading from a book', NULL, 2),
(469, 4, 'What does the woman notify the man about?', NULL, 'C', 'She is unable to meet a deadline.', 'She needs a replacement laptop.', 'She cannot attend a business trip.', 'She is planning to give a speech.', NULL, 2),
(470, 4, 'According to the woman, what recently happened in her department?', NULL, 'D', 'A corporate policy was updated.', 'A supply order was mishandled.', 'Client contracts were renewed.', 'New employees were hired.', NULL, 2),
(471, 4, 'What does the man say he will do next?', NULL, 'A', 'Speak with a colleague', 'Conduct an interview', 'Calculate a budget', 'Draft a travel itinerary', NULL, 2),
(472, 4, 'What does the man want to do?', NULL, 'D', 'Purchase an area map', 'See an event schedule', 'Cancel a hotel reservation', 'Book a bus tour', NULL, 2),
(473, 4, 'What is the man asked to choose?', NULL, 'B', 'When to arrive', 'What to visit', 'How to pay', 'What to eat', NULL, 2),
(474, 4, 'What does the woman suggest doing?', NULL, 'D', 'Wearing a jacket', 'Using a credit card', 'Bringing a camera', 'Looking for a coupon', NULL, 2),
(475, 4, 'What does the man offer to do?', NULL, 'C', 'Meet in the lobby', 'Contact a receptionist', 'Carry some files', 'Delay a meeting', NULL, 2),
(476, 4, 'According to the man, what happened last week?', NULL, 'C', 'An office door would not lock.', 'A sink was installed incorrectly.', 'An elevator stopped working.', 'A document was lost.', NULL, 2),
(477, 4, 'Why does the woman say, “a piece of hardware had to be custom made”?', NULL, 'B', 'To justify a price', 'To explain a delay', 'To illustrate a product\'s age', 'To express regret for a purchase', NULL, 2),
(478, 4, 'What product are the speakers discussing?', NULL, 'C', 'Electronics', 'Office furniture', 'Calendars', 'Clothing', NULL, 2),
(479, 4, 'What does Donna suggest?', NULL, 'C', 'Hiring additional staff', 'Revising a budget', 'Posting some photos online', 'Reducing prices', NULL, 2),
(480, 4, 'What does the man propose?', NULL, 'B', 'Postponing a decision', 'Conducting a survey', 'Developing new products', 'Opening another location', NULL, 2),
(481, 4, 'Who most likely is the man?', NULL, 'A', 'A manager', 'A consultant', 'A client', 'A trainee', NULL, 2),
(482, 4, 'What does the woman ask the man for?', NULL, 'D', 'Some feedback', 'Some assistance', 'Some references', 'Some dates', NULL, 2),
(483, 4, 'What will the man receive?', NULL, 'D', 'Extra time off', 'A promotion', 'Bonus pay', 'An award', NULL, 2),
(484, 4, 'What type of product is being discussed?', NULL, 'D', 'A musical instrument', 'A kitchen appliance', 'A power tool', 'A tablet computer', NULL, 2),
(485, 4, 'Which product feature is the man most proud of?', NULL, 'A', 'The battery life', 'The color selection', 'The sound quality', 'The size', NULL, 2),
(486, 4, 'Why does the man say, “my favorite singer is performing that night”?', NULL, 'C', 'To request a schedule change', 'To explain a late arrival', 'To decline an invitation', 'To recommend a musician', NULL, 2),
(487, 4, 'What type of event is being planned?', NULL, 'B', 'A trade show', 'An awards ceremony', 'A film festival', 'A wedding', NULL, 2),
(488, 4, 'What does the man ask about?', NULL, 'C', 'Accommodations', 'Entertainment', 'Meal options', 'Outdoor seating', NULL, 2),
(489, 4, 'What does the hotel offer for free?', NULL, 'D', 'Meals', 'Internet access', 'Transportation', 'Parking', NULL, 2),
(490, 4, 'What problem does the man mention?', NULL, 'B', 'His car is out of fuel.', 'His phone battery is empty.', 'He is late for an appointment.', 'He forgot his wallet.', NULL, 2),
(491, 4, 'Where are the speakers?', NULL, 'B', 'At a train station', 'At an electronics repair shop', 'At a furniture store', 'At a coffee shop', NULL, 2),
(492, 4, 'What does the woman suggest the man do?', NULL, 'A', 'Check a Web site', 'Call a taxi', 'Return at a later time', 'Go to the library', NULL, 2),
(493, 4, 'What is the man having trouble with?', NULL, 'C', 'Conducting a test', 'Preparing a bill', 'Contacting a patient', 'Shipping an order', NULL, 2),
(494, 4, 'Look at the graphic. Which code should the man use?', NULL, 'C', '01B', '019', '020', '021', NULL, 2),
(495, 4, 'What does the woman say will happen soon?', NULL, 'C', 'Some patients will be transferred to another doctor.', 'Some employees will join a medical practice.', 'A list will be available electronically.', 'A doctor will begin a medical procedure.', NULL, 2),
(496, 4, 'What does the woman say they will need to do?', NULL, 'D', 'Rent storage space', 'Increase production', 'Organize a fashion show', 'Update some equipment', NULL, 2),
(497, 4, 'What does the man suggest?', NULL, 'B', 'Conferring with a client', 'Contacting another department', 'Photographing some designs', 'Changing suppliers', NULL, 2),
(498, 4, 'Look at the graphic. Which section of the label will the men need to revise?', NULL, 'C', 'The logo', 'The material', 'The care instructions', 'The country of origin', NULL, 2),
(499, 4, 'What are the speakers mainly discussing?', NULL, 'C', 'A job interview', 'A company celebration', 'An office relocation', 'A landscaping project', NULL, 2),
(500, 4, 'Look at the graphic. Which building is Silverby Industries located in?', NULL, 'B', 'Building 1', 'Building 2', 'Building 3', 'Building 4', NULL, 2),
(501, 4, 'What does the woman tell the man about parking?', NULL, 'C', 'He should park in a visitor\'s space.', 'He will have to pay at a meter.', 'A parking pass is required.', 'The parking area fills up quickly.', NULL, 2),
(502, 4, 'What type of business is being advertised?', NULL, 'B', 'A farmers market', 'A fitness center', 'A medical clinic', 'A sporting goods store', NULL, 1),
(503, 4, 'What will the listeners be able to do starting in April?', NULL, 'C', 'Use multiple locations', 'Try free samples', 'Meet with a nutritionist', 'Enter a contest', NULL, 1),
(504, 4, 'Why does the speaker invite the listeners to visit a Web site?', NULL, 'D', 'To write a review', 'To register for a class', 'To check a policy', 'To look at a map', NULL, 1),
(505, 4, 'Why does the speaker thank the listeners?', NULL, 'C', 'For submitting design ideas', 'For training new employees', 'For working overtime', 'For earning a certification', NULL, 1),
(506, 4, 'According to the speaker. what is scheduled for next month?', NULL, 'D', 'A retirement celebration', 'A trade show', 'A factory tour', 'A store opening', NULL, 1),
(507, 4, 'What does the speaker imply when she says, “it’s a large space\"?', NULL, 'A', 'There is room to display new merchandise.', 'High attendance is anticipated.', 'Avenue is too expensive.', 'There is not enough staff for an event.', NULL, 1),
(508, 4, 'According to the speaker. what is special about the restaurant?', NULL, 'C', 'It has private outdoor seating.', 'It has been recently renovated.', 'It has a vegetable garden.', 'It has weekly cooking classes.', NULL, 1),
(509, 4, 'Who is Natasha?', NULL, 'D', 'A business owner', 'An interior decorator', 'An event organizer', 'A food writer', NULL, 1),
(510, 4, 'Why does the speaker say, “I eat it all the time”?', NULL, 'B', 'He wants to eat something different.', 'He is recommending a dish.', 'He knows the ingredients.', 'He understands a dish is popular.', NULL, 1),
(511, 4, 'Where is the announcement being made?', NULL, 'C', 'On a bus', 'On a ferry boat', 'On a train', 'On an airplane', NULL, 1),
(512, 4, 'What problem does the speaker mention?', NULL, 'D', 'There is no more room for large bags.', 'Too many tickets have been sold.', 'Weather conditions have changed.', 'A piece of equipment is being repaired.', NULL, 1),
(513, 4, 'According to the speaker, why should the listeners talk with a staff member?', NULL, 'D', 'To receive a voucher', 'To reserve a seat', 'To buy some food', 'To get free headphones', NULL, 1),
(514, 4, 'Who is the speaker?', NULL, 'D', 'A repair person', 'A store clerk', 'A factory worker', 'A truck driver', NULL, 1),
(515, 4, 'What does the company sell?', NULL, 'D', 'Household furniture', 'Kitchen appliances', 'Packaged foods', 'Construction equipment', NULL, 1),
(516, 4, 'What does the speaker imply when she says, “all I see are houses”?', NULL, 'B', 'She is concerned about some regulations.', 'She thinks a mistake has been made.', 'A loan application has been completed.', 'A development plan cannot be approved.', NULL, 1),
(517, 4, 'What is the talk mainly about?', NULL, 'D', 'A mobile phone model', 'An office security system', 'High-speed Internet service', 'Business scheduling software', NULL, 1),
(518, 4, 'Why did the company choose the product?', NULL, 'A', 'It makes arranging meetings easy.', 'It is reasonably priced.', 'It has good security features.', 'It has received positive reviews.', NULL, 1),
(519, 4, 'What does the speaker say is offered with the product?', NULL, 'D', 'An annual upgrade', 'A money-back guarantee', 'A mobile phone application', 'A customer-service help line', NULL, 1),
(520, 4, 'What does the speaker say has recently been announced?', NULL, 'C', 'An increase in funding', 'A factory opening', 'A new venue for an event', 'A change in regulations', NULL, 1),
(521, 4, 'According to the speaker. why do some people dislike a construction project?', NULL, 'D', 'Because it caused a power outage', 'Because it costs too much', 'Because roads have been closed', 'Because of the loud noise', NULL, 1),
(522, 4, 'What will the speaker do next?', NULL, 'C', 'Introduce an advertiser', 'Attend a press conference', 'Interview some people', 'End a broadcast', NULL, 1),
(523, 4, 'What does the speaker thank the listeners for?', NULL, 'C', 'Reorganizing some files', 'Cleaning a work area', 'Working on a Saturday', 'Attending a training', NULL, 1),
(524, 4, 'In which division do the listeners most likely work?', NULL, 'A', 'Shipping and Receiving', 'Maintenance', 'Sales and Marketing', 'Accounting', NULL, 1),
(525, 4, 'What does the speaker say he will provide?', NULL, 'C', 'A building name', 'Group numbers', 'Shift schedules', 'A temporary password', NULL, 1),
(526, 4, 'What event is being described?', NULL, 'C', 'A sports competition', 'A government ceremony', 'A music festival', 'A cooking contest', NULL, 1),
(527, 4, 'According to the speaker. what can the listeners find on a Web site?', NULL, 'B', 'A city map', 'A list of vendors', 'A demonstration video', 'An entry form', NULL, 1),
(528, 4, 'Look at the graphic. Which day is the event being held?', NULL, 'A', 'Saturday', 'Sunday', 'Monday', 'Tuesday', NULL, 1),
(529, 4, 'What is the purpose of the call?', NULL, 'C', 'To confirm a deadline', 'To explain a company policy', 'To make a job offer', 'To discuss a new product', NULL, 1),
(530, 4, 'Look at the graphic. Who is the speaker calling?', NULL, 'D', 'Carla Wynn', 'JaeI-lo Kim', 'Kaori Aoki', 'Alex Lehmann', NULL, 1),
(531, 4, 'What does the speaker ask the listener to do?', NULL, 'C', 'Check a catalog', 'Send fee information', 'Submit a travel itinerary', 'Update a conference schedule', NULL, 1),
(532, 4, 'What does the company most likely produce?', NULL, 'C', 'Print advertisements', 'Television shows', 'Computer parts', 'Musical instruments', NULL, 3),
(533, 4, 'What department will the man work in?', NULL, 'C', 'Accounting', 'Legal', 'Human resources', 'Security', NULL, 3),
(534, 4, 'What does the man like about his work area?', NULL, 'B', 'It is conveniently located.', 'It has a good view.', 'It is quiet.', 'It is nicely decorated.', NULL, 3),
(535, 4, 'What is the conversation mainly about?', NULL, 'A', 'A room reservation', 'A canceled event', 'A restaurant recommendation', 'A misplaced item', NULL, 3),
(536, 4, 'What does the men need to provide?', NULL, 'C', 'A security deposit', 'A revised schedule', 'A form of identification', 'A business address', NULL, 3),
(537, 4, 'What do the visitors ask for?', NULL, 'D', 'A refund', 'Better lighting', 'Menu options', 'More chairs', NULL, 3),
(538, 4, 'Where does the conversation most likely take place?', NULL, 'B', 'At a shopping mall', 'At a theater', 'In a sports stadium', 'On a train', NULL, 3),
(539, 4, 'Why does the woman say, \"The football championship is this afternoon\"?', NULL, 'C', 'To extend an invitation', 'To offer encouragement', 'To give an explanation', 'To request a schedule change', NULL, 3),
(540, 4, 'What does the man say he needs to purchase?', NULL, 'A', 'Tickets', 'Clothes', 'Food', 'Furniture', NULL, 3),
(541, 4, 'What problem does the man mention?', NULL, 'D', 'Some products are damaged.', 'Some equipment is out of stock.', 'A vehicle has broken down.', 'A delivery error has occurred.', NULL, 3),
(542, 4, 'What does the woman say is planned for Friday?', NULL, 'A', 'A product launch', 'An inspection', 'A cooking class', 'An interview', NULL, 3),
(543, 4, 'What does the men say he will do?', NULL, 'B', 'Transfer 8 call', 'Issue a refund', 'Provide a warranty', 'Visit a business', NULL, 3),
(544, 4, 'Where do the speakers most likely work?', NULL, 'D', 'At a law office', 'At a supermarket', 'At a medical clinic', 'At a recreation center', NULL, 3),
(545, 4, 'What are the speakers mainly discussing?', NULL, 'B', 'A marketing campaign', 'A new product', 'Some budget cuts', 'Some survey results', NULL, 3),
(546, 4, 'What does the woman imply when she says, \"That would require significant revisions to our scheduling process\"?', NULL, 'A', 'She doubts a change will be implemented.', 'She thinks more staff should be hired.', 'She needs more time to make a decision.', 'She believes some data is incorrect.', NULL, 3),
(547, 4, 'Why did the woman miss a meeting?', NULL, 'D', 'She was not feeling well.', 'She was on a business trip.', 'She was speaking with a client.', 'She did not receive the invitation.', NULL, 3);
INSERT INTO `exam_question` (`question_id`, `exam_id`, `content`, `audio_url`, `correct_answer`, `option_1`, `option_2`, `option_3`, `option_4`, `passage_id`, `listening_id`) VALUES
(548, 4, 'What is the woman confused about?', NULL, 'B', 'The details of an assignment', 'A reimbursement process', 'The terms of a contract', 'A travel itinerary', NULL, 3),
(549, 4, 'According to the man, what should the woman do?', NULL, 'C', 'Reset the password for her computer', 'Talk to the organizer of the meeting', 'Consult the electronic version of a document', 'Research the history of an account', NULL, 3),
(550, 4, 'What is the woman an expert in?', NULL, 'B', 'Gardening', 'Nutrition', 'Appliance repair', 'Fitness training', NULL, 3),
(551, 4, 'What does the woman recommend?', NULL, 'A', 'Substituting ingredients', 'Using appropriate tools', 'Changing an exercise routine', 'Scheduling regular maintenance', NULL, 3),
(552, 4, 'According to the woman, where can listeners find more information?', NULL, 'B', 'On a television show', 'On a Web site', 'In a magazine', 'In a book', NULL, 3),
(553, 4, 'What does the woman say about the man\'s job performance?', NULL, 'A', 'He is respected by his colleagues.', 'He always meets his deadlines.', 'He has good ideas for new projects.', 'He has increased company profits.', NULL, 3),
(554, 4, 'What does the woman ask the man to do?', NULL, 'C', 'Attend a trade show', 'Join a leadership council', 'Mentor a colleague', 'Accept a new position', NULL, 3),
(555, 4, 'When will the speakers meet again?', NULL, 'B', 'Tomorrow', 'Next week', 'Next month', 'Next quarter', NULL, 3),
(556, 4, 'What does the man ask the women about?', NULL, 'D', 'The types of projects assigned', 'The backgrounds of the applicants', 'The status of training materials', 'The location of an orientation', NULL, 3),
(557, 4, 'What does the man say about last year\'s internship program?', NULL, 'D', 'Some new products were developed.', 'Some information was unclear.', 'There were not enough supplies.', 'There were a large number of applicants.', NULL, 3),
(558, 4, 'What does the men say he is pleased about?', NULL, 'B', 'The summer schedule', 'The careful planning', 'The deadline extension', 'The approval process', NULL, 3),
(559, 4, 'What type of business does the woman work for?', NULL, 'B', 'A moving company', 'A real estate agency', 'An insurance firm', 'An equipment rental service', NULL, 3),
(560, 4, 'What is the woman concerned about?', NULL, 'B', 'Shipping delays', 'New regulations', 'An increase in competition', 'A shortage of staff', NULL, 3),
(561, 4, 'What does the woman emphasize about her company?', NULL, 'D', 'The affordable prices', 'The number of branch offices', 'The user-friendly Web site', 'The customer service', NULL, 3),
(562, 4, 'What type of event are the speakers discussing?', NULL, 'C', 'A shareholders\' meeting', 'A press conference', 'A job fair', 'A product demonstration', NULL, 3);
